...
@Component({
    selector: 'prospectoseguimientoreportes-comp',
    templateUrl: './prospectoseguimientoreportes.component.html',
    animations: [fadeInOut],
})
export class ProspectoSeguimientoReportesComponent {
    ...
    constructor(@Inject('BASE_URL') private url: string, private http: HttpClient, public user: StoreUser, private rtr: Router, private sanitizer: DomSanitizer) {
        ...
        const urlProj = `https://www.singa.com.mx:8097/reportes?user_id=${this.user.idPersonal}`;
    ...
    nuevo() {
        this.rtr.navigate(['/exclusivo/nuevopros']);
    }
}