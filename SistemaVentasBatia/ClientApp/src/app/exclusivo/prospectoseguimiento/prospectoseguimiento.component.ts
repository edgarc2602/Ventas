...
@Component({
    selector: 'prospectoseguimiento-comp',
    templateUrl: './prospectoseguimiento.component.html',
    animations: [fadeInOut],
})
export class ProspectoSeguimientoComponent {
    ...
    constructor(@Inject('BASE_URL') private url: string, private http: HttpClient, public user: StoreUser, private rtr: Router, private sanitizer: DomSanitizer) {
        ...
        const urlProj = `https://www.singa.com.mx:8097/clientes?user_id=${this.user.idPersonal}`;
