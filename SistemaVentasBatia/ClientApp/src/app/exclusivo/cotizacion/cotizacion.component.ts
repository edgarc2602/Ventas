...
export class CotizacionComponent implements OnInit, OnDestroy {
    ...
    model: CotizaResumenLim = {
        ...
        total: 0, idCotizacionOriginal: 0, idServicio: 0, nombreComercial: '', indirectoPor: '', utilidadPor: '', csvPor: '', comisionSV: 0, comisionExtPor: '', comisionExt: 0, totalPolizaCumplimiento: 0, polizaCumplimiento: false, idEstatus: 0, diasEvento: 0, polizaPor : '', financiamiento: 0, porcentajeFinanciamiento: 0
    };
